    ...
    def __init__(self):
        ...
        if self.tushare_token:
            try:
                ...
                _safe_print(f"Tushare数据源初始化失败: {e}")
                self.tushare_available = False
        else:
            _safe_print("未配置Tushare Token，将仅使用Akshare数据源")
